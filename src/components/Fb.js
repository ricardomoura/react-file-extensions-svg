...
<svg width={size} height={size} viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fillRule="evenodd">
        <g id="file-type-icon-set" transform="translate(-532.000000, -687.000000)" fill={color}>
            <g id="Fb" transform="translate(532.000000, 687.000000)">
